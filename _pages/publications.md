...
<div class="intro text-center" style="max-width: 800px; margin: 0 auto 2rem auto; color: #cbd5e1;">
  <p>Conference papers, technical manuals, and open-source software contributions on flood risk, dam safety, and hydrology.</p>
</div>
...
<div style="background: rgba(255,255,255,0.04); border-left: 4px solid #2e8bc0; border-radius: 6px; padding: 1.2rem 1.5rem; margin-bottom: 1.5rem;">
  <h3 style="margin-bottom: 0.3rem;">One breach or more? — Assessment of potential multiple flood overtopping breaches and sequencing</h3>
  <p style="font-size: 0.85rem; color: #94a3b8; margin-bottom: 0.8rem;">
...
## <i class="fas fa-book"></i> Technical Manuals & Guidance

<div style="background: rgba(255,255,255,0.04); border-left: 4px solid #2e8bc0; border-radius: 6px; padding: 1.2rem 1.5rem; margin-bottom: 1.5rem;">
  <h3 style="margin-bottom: 0.3rem;">TMR Bridge Scour Manual (2013)</h3>
  <p style="font-size: 0.85rem; color: #94a3b8; margin-bottom: 0.8rem;">
    <strong>Department of Transport and Main Roads, Queensland</strong> · 2013
  </p>
  <p>Queensland's first statewide bridge scour guidance document, authored during tenure at TMR. Provides standardised methodology for scour assessment, risk categorisation, and maintenance decisions across the state road network.</p>
</div>

<div style="background: rgba(255,255,255,0.04); border-left: 4px solid #2e8bc0; border-radius: 6px; padding: 1.2rem 1.5rem; margin-bottom: 1.5rem;">
  <h3 style="margin-bottom: 0.3rem;">SEQFEWS User Manual (2017)</h3>
  <p style="font-size: 0.85rem; color: #94a3b8; margin-bottom: 0.8rem;">
    <strong>Seqwater</strong> · 2017
  </p>
  <p>Technical documentation for the SEQFEWS real-time flood forecasting system used in dam operations for Wivenhoe and North Pine Dams. Covers model configuration, operational procedures, and system maintenance.</p>
</div>
...
<div style="background: rgba(255,255,255,0.04); border-left: 4px solid #2e8bc0; border-radius: 6px; padding: 1.2rem 1.5rem; margin-bottom: 1.5rem;">
  <h3 style="margin-bottom: 0.3rem;">pyextremes — ARR2019_Book3</h3>
  <p style="font-size: 0.85rem; color: #94a3b8; margin-bottom: 0.8rem;">
    <strong>Python · GitHub Fork</strong> · Active Development
  </p>
...
<div style="background: rgba(255,255,255,0.04); border-left: 4px solid #2e8bc0; border-radius: 6px; padding: 1.2rem 1.5rem; margin-bottom: 1.5rem;">
  <h3 style="margin-bottom: 0.3rem;">PyRomb — URBS Model Builder</h3>
  <p style="font-size: 0.85rem; color: #94a3b8; margin-bottom: 0.8rem;">
    <strong>Python · Pull request merged upstream</strong> by Tom Norman
  </p>
  <p>Wrote the URBS runoff model builder component of the PyRomb QGIS plugin. Pull request accepted into the main repository — enabling URBS and RORB model setup directly within the QGIS environment.</p>
  <p style="margin-top: 0.5rem; font-size: 0.9rem;">
    <a href="https://github.com/lmillard79/PyRomb_ModelBuilder" target="_blank" rel="noopener">GitHub</a>
  </p>
</div>

<div style="background: rgba(255,255,255,0.04); border-left: 4px solid #2e8bc0; border-radius: 6px; padding: 1.2rem 1.5rem; margin-bottom: 1.5rem;">
  <h3 style="margin-bottom: 0.3rem;">tuflow-vscode · Billabong QGIS Plugin</h3>
  <p style="font-size: 0.85rem; color: #94a3b8; margin-bottom: 0.8rem;">
    <strong>TypeScript / Python</strong>
  </p>
  <p>VS Code extension for TUFLOW hydraulic model file syntax and IntelliSense. Billabong: Python QGIS plugin for hydrological data processing, published to the QGIS Plugin Repository.</p>
  <p style="margin-top: 0.5rem; font-size: 0.9rem;">
    <a href="/projects/">View all repositories →</a>
  </p>
</div>
...
Presented at: **HWRS** · **ANCOLD** · **QWS** · **FMA** · **IPWEA**

<div class="notice--info" style="margin-top: 2rem;">
  <p>Additional publications and a full list of conference presentations are available on my <a href="https://www.linkedin.com/in/lindsaymillard" target="_blank" rel="noopener">LinkedIn profile</a>.</p>
</div>
