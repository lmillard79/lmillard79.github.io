...
<div class="feature__wrapper">
  <div class="feature__item" style="display: flex; align-items: center; margin-bottom: 20px;">
    <div class="feature__content" style="flex: 1;">
      <h3 style="margin-top: 0;">Technical Implementation</h3>
      <ul>
        <li>XML parsing and generation for FEWS PI schema compliance</li>
        <li>Pandas DataFrame manipulation for efficient data transformation</li>
        <li>NumPy arrays for handling time series data</li>
        <li>Automated batch processing workflows</li>
        <li>Integration with GoldSim simulation models</li>
      </ul>
      <h3 style="margin-top: 0;">Key Achievements</h3>
      <ul>
        <li>Reduced manual data processing time by 80%</li>
        <li>Enabled real-time model execution within FEWS framework</li>
        <li>Created reusable adapter framework for multiple model types</li>
      </ul>
      <h3 style="margin-top: 0;">Project Impact</h3>
      <ul>
        <li>Improved operational efficiency for flood forecasting</li>
        <li>Enhanced decision-making capabilities for water managers</li>
        <li>Reduced risk of manual data entry errors</li>
      </ul>
    </div>
  </div>
</div>

[View Technical Details](/DFUDA-FEWSAdapter/){: .btn .btn--primary}
...
<div class="feature__wrapper">
  <div class="feature__item" style="display: flex; align-items: center; margin-bottom: 20px;">
    <div class="feature__content" style="flex: 1;">
      <h3 style="margin-top: 0;">Modeling Approaches</h3>
      <ul>
      ...
      <h3 style="margin-top: 0;">Technical Skills Applied</h3>
      <ul>
...
<div class="feature__wrapper">
  <div class="feature__item" style="display: flex; align-items: center; margin-bottom: 20px;">
    <div class="feature__content" style="flex: 1;">
      <h3 style="margin-top: 0;">Technical Components</h3>
      <ul>
        ...
        <li>Integration with GIS for spatial analysis</li>
      </ul>
      <h3 style="margin-top: 0;">Project Highlights</h3>
      <ul>
        <li>Bridge scour assessment and mitigation design</li>
        <li>Urban flood risk management strategies</li>
        <li>Mine site water management planning</li>
        <li>Transport infrastructure drainage design</li>
      </ul>
      <h3 style="margin-top: 0;">Project Impact</h3>
      <ul>
        <li>Enhanced infrastructure resilience to flood events</li>
        <li>Reduced risk to public safety and property</li>
        <li>Optimized design solutions for cost-effectiveness</li>
        <li>Improved regulatory compliance for development projects</li>
      </ul>
    </div>
  </div>
</div>
...
<div class="feature__wrapper">
  <div class="feature__item" style="display: flex; align-items: center; margin-bottom: 20px;">
    <div class="feature__content" style="flex: 1;">
      <h3 style="margin-top: 0;">Analytical Methods</h3>
      <ul>
      ...
      <h3 style="margin-top: 0;">Tools & Technologies</h3>
      <ul>
      ...
      <h3 style="margin-top: 0;">Project Impact</h3>
      <ul>
        <li>Improved accuracy of flood risk predictions</li>
        <li>Enhanced understanding of hydrological uncertainties</li>
        <li>More informed decision-making for water resources planning</li>
        <li>Streamlined data processing and analysis workflows</li>
      </ul>
    </div>
  </div>
</div>
